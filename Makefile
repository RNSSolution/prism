...
draw_deps:
	...
	@goviz -i github.com/ColorPlatform/prism/cmd/prism -d 3 | dot -Tpng -o dependency-graph.png
...
rpc-docs:
	...
	godoc2md -template rpc/core/doc_template.txt github.com/ColorPlatform/prism/rpc/core | grep -v -e "pipe.go" -e "routes.go" -e "dev.go" | sed 's,/src/target,https://github.com/ColorPlatform/prism/tree/master/rpc/core,' >> $(DESTINATION)
...
build-docker:
	...
	docker build --label=prism --tag="ColorPlatform/prism" DOCKER
	rm -rf DOCKER/prism

...
// Examples
//
// - [Tendermint](https://github.com/ColorPlatform/prism/blob/master/rpc/core/routes.go)
// - [tm-monitor](https://github.com/ColorPlatform/prism/blob/master/tools/tm-monitor/rpc.go)
package rpc

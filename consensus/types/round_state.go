...
const (
	...
	RoundStepIntraLeaguePrevote     = RoundStepType(0x06) // As league leader communicates with leaders of other leagues
	RoundStepIntraLeaguePrevoteWait = RoundStepType(0x07) // As league leader received +2/3 of votes, starts timeout

	RoundStepIntraLeaguePrecommit     = RoundStepType(0x08) // As league leader did precommit, gossip precommits
	RoundStepIntraLeaguePrecommitWait = RoundStepType(0x09) // As league leader received any +2/3 precommits, start timeout
...
func (rs RoundStepType) String() string {
	...
	case RoundStepIntraLeaguePrevote:
		return "RoundStepIntraLeaguePrevote"
	case RoundStepIntraLeaguePrevoteWait:
		return "RoundStepIntraLeaguePrevoteWait"
	case RoundStepIntraLeaguePrecommit:
		return "RoundStepIntraLeaguePrecommit"
	case RoundStepIntraLeaguePrecommitWait:
		return "RoundStepIntraLeaguePrecommitWait"
